...
local allocate = Instance.new("TextLabel")
...
Frame.Position = UDim2.new(0.383109272, 0, 0.373720109, 0)
Frame.Size = UDim2.new(0, 556, 0, 327)

Topbar.Name = "Topbar"
Topbar.Parent = Frame
Topbar.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
Topbar.BorderColor3 = Color3.fromRGB(170, 0, 255)
Topbar.Size = UDim2.new(0, 556, 0, 26)

allocate.Name = "allocate"
allocate.Parent = Topbar
allocate.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
allocate.BackgroundTransparency = 1.000
allocate.BorderColor3 = Color3.fromRGB(27, 42, 53)
allocate.Position = UDim2.new(0.345598787, 0, 0, 0)
allocate.Size = UDim2.new(0, 186, 0, 35)
allocate.Font = Enum.Font.LuckiestGuy
allocate.Text = "ALLOCATE"
allocate.TextColor3 = Color3.fromRGB(255, 255, 255)
allocate.TextSize = 18.000

TextButton.Parent = Topbar
TextButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
TextButton.BorderColor3 = Color3.fromRGB(27, 42, 53)
TextButton.BorderSizePixel = 0
TextButton.Position = UDim2.new(0.960431635, 0, 0, 0)
...
Exe.Name = "Exe"
Exe.Parent = Frame
Exe.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
Exe.BorderColor3 = Color3.fromRGB(170, 0, 255)
Exe.Position = UDim2.new(0.0541230403, 0, 0.827988327, 0)
Exe.Size = UDim2.new(0, 130, 0, 28)
...
Clr.Name = "Clr"
Clr.Parent = Frame
Clr.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
Clr.BorderColor3 = Color3.fromRGB(170, 0, 255)
Clr.Position = UDim2.new(0.299997628, 0, 0.827988327, 0)
Clr.Size = UDim2.new(0, 130, 0, 28)
Clr.Font = Enum.Font.FredokaOne
Clr.Text = "Clear"
...
HideText.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
HideText.BorderColor3 = Color3.fromRGB(170, 0, 255)
HideText.Position = UDim2.new(0.546169043, 0, 0.827988327, 0)
HideText.Size = UDim2.new(0, 130, 0, 28)
...
R6.Name = "R6"
R6.Parent = Frame
R6.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
R6.BorderColor3 = Color3.fromRGB(170, 0, 255)
R6.Position = UDim2.new(0.794732571, 0, 0.827988327, 0)
R6.Size = UDim2.new(0, 21, 0, 21)
...
RE.Name = "RE"
RE.Parent = Frame
RE.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
RE.BorderColor3 = Color3.fromRGB(170, 0, 255)
RE.Position = UDim2.new(0.844237506, 0, 0.827988327, 0)
RE.Size = UDim2.new(0, 21, 0, 21)
...
Frame1.Position = UDim2.new(0.105395697, 0, 0.146402806, 0)
Frame1.Size = UDim2.new(0, 422, 0, 214)

TextBox.Parent = Frame1
TextBox.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
TextBox.BorderColor3 = Color3.fromRGB(170, 0, 255)
TextBox.Position = UDim2.new(0.0639077723, 0, -0.0540540516, 0)
TextBox.Size = UDim2.new(0, 404, 0, 222)
TextBox.Font = Enum.Font.Ubuntu
TextBox.PlaceholderText = "-- Put your script here"
TextBox.Text = ""
...
Frame_2.BorderColor3 = Color3.fromRGB(170, 0, 255)
Frame_2.Position = UDim2.new(-0.065699555, 0, -0.0540540516, 0)
Frame_2.Size = UDim2.new(0, 48, 0, 222)
...
local function SXNDDZ_fake_script() -- TextButton.Script 
...
coroutine.wrap(SXNDDZ_fake_script)()
local function AJZBEET_fake_script() -- Exe.Script 
...
coroutine.wrap(AJZBEET_fake_script)()
local function IESN_fake_script() -- Exe.LocalScript 
...
coroutine.wrap(IESN_fake_script)()
local function RHOU_fake_script() -- Clr.Script 
	local script = Instance.new('Script', Clr)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
		if fake then
	...
	box = script.Parent.Parent.Frame1.TextBox
...
coroutine.wrap(RHOU_fake_script)()
local function TGHV_fake_script() -- HideText.LocalScript 
...
coroutine.wrap(TGHV_fake_script)()
local function DHFWKL_fake_script() -- R6.LocalScript 
...
coroutine.wrap(DHFWKL_fake_script)()
local function JWMFY_fake_script() -- nil.Script 
...
coroutine.wrap(JWMFY_fake_script)()
local function FZIJX_fake_script() -- RE.LocalScript 
	...
	script.Parent.Parent.RE.MouseButton1Click:Connect(function()
			script.Parent.ServerEvents.Respawn:FireServer()
		end)
end
coroutine.wrap(FZIJX_fake_script)()
local function VTLFRL_fake_script() -- RE.ServerEvents 
...
coroutine.wrap(VTLFRL_fake_script)()
local function FWSYXB_fake_script() -- Frame.Dragify 
...
coroutine.wrap(FWSYXB_fake_script)()
